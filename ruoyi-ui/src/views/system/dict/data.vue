<template>
  <div class="app-container search-table-box aidex-table">
            ...
            <el-row :gutter="16">
              ...
              <el-col :md="6">
                <el-form-item label="状态" prop="status">
                  <el-select v-model="queryParams.status" placeholder="数据状态" @change="handleQuery" style="width: 100%" clearable>
                    <el-option
    ...
    <el-card shadow="never" >
        ...
        <el-row>
          <el-col :span="8">
            <div class="card-header">
              <el-button disabled type="text">字典数据</el-button>
            </div>
          </el-col>
          <el-col :span="16">
      ...
      <el-table ref="tableRef" v-loading="loading" :data="dataList" @selection-change="handleSelectionChange"  highlight-current-row style="width: 100%;" :height="tableHeight">
            ...
            <el-row :gutter="24">
              ...
              <el-col :span="12">
                <el-form-item label="显示排序" prop="dictSort">
                  <el-input-number :step="10" v-model="form.dictSort" controls-position="right" style="width: 100%;" :min="10" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
