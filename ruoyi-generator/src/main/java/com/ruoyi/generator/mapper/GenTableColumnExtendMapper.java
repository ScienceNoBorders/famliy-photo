 ...
 * @author ruoyi
 */
public interface GenTableColumnExtendMapper
{
    /**
     * 根据表名称查询列信息
     * 
     ...
     * @return 列信息
     */
    public List<GenTableColumnExtend> selectDbTableColumnsByName(String tableName);
     ...
     * @return 结果
     */
    public int deleteGenTableColumns(List<GenTableColumnExtend> genTableColumns);
