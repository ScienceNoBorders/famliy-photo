 ...
 * @author ruoyi
 */
public interface GenTableExtendMapper
{
    /**
     * 查询业务列表
     * 
     ...
     * @return 业务信息
     */
    public GenTableExtend selectGenTableByName(String tableName);
     ...
     * @return 结果
     */
    public int insertGenTable(GenTableExtend genTable);
     ...
     * @return 结果
     */
    public int updateGenTable(GenTableExtend genTable);
